...
public class GalleryApiController {
    ...
    public String updateGalleryItem(@PathVariable(name = "id") Integer id, @RequestBody GalleryItem galleryItem) {
        galleryService.save(galleryItem);
        log.info("gallery item was updated");
        return "{\"HttpStatus\": \"ok\"}";
    }

    @PostMapping(value = "/", produces = MediaType.APPLICATION_JSON_VALUE)
    public List<GalleryItemDto> createGalleryItem(@RequestBody GalleryItem galleryItem) {
        galleryService.save(galleryItem);
